...
It can be used in please of Route, best used when dev not using Route. 

2. How would you explain form validation to someone who has never programmed before?
Validation is given the user the info that the form hasn't been completed to standard

3. In 1-2 sentences, define end to end testing.
end to end testing is a stimulation of real world testing to ensure application is running properly
